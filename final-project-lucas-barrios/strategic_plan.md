...
**Goal:** Validate that the AI diagnostic produces useful, accurate results that convert to paid consultations.
...
- 3+ students convert to paid consultation (15% conversion)
...
**Revenue target:** 3 conversions × €499 = €1,497
...
**Revenue target:** 100 × 15% × €499 = €7,485/month

---

### Phase 3 — Scale (Months 2–6)
**Goal:** Reach €25,000/month revenue. Add UC-02 (Ausbildung Matcher). Hire one part-time advisor. Explore B2B institutional partnerships.

**Scope:**
- UC-02 Ausbildung Position Matcher launched
- UC-04 German Document Factory launched (cover letters, CVs in German)
- Small team of 3 (Cleo + 1 advisor + 1 developer part-time)
...
- 2 B2B partnership agreements signed
- EU AI Act registration complete
- Full GDPR compliance documentation published

**Cost:** ~€16,000/month (small team)
**Revenue target:** 200 × 20% × €625 avg ticket = €25,000/month
...
B2B deal: white-label platform access or batch diagnostic processing at €25–€50 per student profile.
...
|---|---|---|
| Free Diagnostic | €0 | Readiness score + roadmap (reviewed by consultant) |
| Guided Consultation | €99 | Diagnostic + 45-minute video call with Cleo |
| Full Service | €499 | Diagnostic + 3 sessions + document review + application support |
| Premium | €1,500 | Diagnostic + 6 months of dedicated advisory support |

The free diagnostic is the lead generation engine. It delivers real value and creates a natural conversion moment: "Your score is 68/100 — you're ready with preparation. Book a consultation to build your action plan."
...
| Average ticket | €499 | €499 | €625 |
| Monthly revenue | €1,497 | €7,485 | €25,000 |
| Review time avg | <3 min | <2 min | <90 sec |
| Student satisfaction | >7/10 | >8/10 | >8.5/10 |
| B2B partnerships | 0 | 0 | 2 signed |
...
**Year 1: Consulting-as-a-Service (B2C)**
Klar operates as Cleo's primary client acquisition and intake tool. Revenue comes from consultation fees at the three paid tiers. The free diagnostic handles all intake and qualification automatically. Cleo's time is freed from intake and directed entirely toward paid consultations.

**Year 2: SaaS + B2B**
Klar becomes a platform that other education consultants and institutions can license. B2B tier: €500/month per consultant seat, including the diagnostic agent and admin dashboard. Institutional tier: bulk processing at €25–€50 per student profile.

**Year 3: Platform**
Klar becomes the infrastructure for Latin American → Germany career pathways. Multiple consultants on the platform. Employer partnerships for Ausbildung candidate placement (placement fee model: €500–€2,000 per successful placement). Partnership revenue from German language schools (referral commission).

**Revenue summary:**

| Year | Model | Revenue Target |
|---|---|---|
| Year 1 | B2C consulting | €120,000 |
| Year 2 | B2C + SaaS | €450,000 |
| Year 3 | Platform + B2B | €1,200,000+ |

---

## 6. Monetization Model — Current State and Phased Roadmap

### Phase 1 — Current (manual conversion, already live)

The free diagnostic (UC-01) functions as the lead magnet. Every approved result includes a personalised next-step message and a Cal.com link offering a free 15-minute consultation with Cleo. That consultation is the primary conversion event: the paid tiers (€99 Guided Consultation, €499 Full Service, €1,500 Premium Advisory) are sold manually by Cleo during or after the call.

**Honest gap:** there is currently no automated payment collection for these tiers. Cleo would send a manual invoice or payment link post-call. This is the most important gap to close in the near term.
...
This is a **self-serve upsell layer** that converts without requiring Cleo's time — structurally distinct from the Phase 1 manual sales process.
...
- **Low-ticket self-serve product:** a fixed-price (~€29) written action plan available via instant Stripe checkout directly from the results page, requiring no consultation call — captures revenue from students who would not otherwise book.
...
|---|---|---|---|
| 1 | Manual sale post-consultation | Yes | Live |
| 1.5 | Stripe paywall (test mode) | No | Built, not production |
| 2 | Affiliate commissions + low-ticket upsell | No | Planned |
| 3 | Subscription + automated Payment Links | Partial | Planned |
