...
# Bump when REGENERATE_SYSTEM in document_factory.py changes.
REGENERATE_PROMPT_VERSION_DEFAULT = "document_factory_regenerate_prompt_v2"
REGENERATE_PROMPT_VERSION = os.getenv(
